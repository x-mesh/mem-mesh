...
async def main():
    ...
    # 임베딩 서비스 초기화
    embedding_service = EmbeddingService(model_name="sentence-transformers/all-MiniLM-L6-v2", preload=True)
    ...
    for metric in recent_metrics:
        print(f"  - Query: '{metric['query']}' | Source: {metric['source']} | Results: {metric['result_count']} | Time: {metric['response_time_ms']}ms")
