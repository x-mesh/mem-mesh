...
# content matches a save category. Auth = shared hook token (env or file).
...
mem_mesh_logv "stop" "config" "url=$API_URL auth=$AUTH_STATE time=${HTTP_META#* }s curl_exit=$CURL_EXIT"
