...
The KEYWORD_MATCHER_BLOCK is injected into shell scripts via the
__KEYWORD_MATCHER__ placeholder at install time.  It reads from stdin
and prints a category name (or 'SKIP').

Usage in shell template:
    CATEGORY=$(python3 -c "
    __KEYWORD_MATCHER__
