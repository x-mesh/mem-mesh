...
class StatsService:
    ...
    async def get_pin_stats(
        ...
        try:
            ...
            importance_breakdown = {row['importance']: row['count'] for row in importance_results}
            ...
            return {
                ...
                "avg_lead_time_hours": round(avg_lead_time, 2) if avg_lead_time else None,
                "min_lead_time_hours": round(min_lead_time, 2) if min_lead_time else None,
                "max_lead_time_hours": round(max_lead_time, 2) if max_lead_time else None,
            ...
            return [
                {
                    ...
                    "avg_lead_time_hours": round(row['avg_lead_time'], 2) if row['avg_lead_time'] else None
                }
                for row in results
            ]
    ...
    async def get_session_stats(
        ...
        try:
            ...
            avg_duration = duration_result['avg_duration_hours'] if duration_result else None
            ...
            return {
                ...
                "avg_session_duration_hours": round(avg_duration, 2) if avg_duration else None
            }
