...
from .common.timezone_middleware import DisplayTimezoneMiddleware
...
def create_app() -> FastAPI:
    ...
    # Outermost: localize UTC timestamps in JSON /api responses to display tz
    # (no-op when display_timezone is UTC). Added last → wraps the others.
