...
class TestMCPSessionLifecycle:
    ...
    async def test_initialize_creates_session(self, http: httpx.AsyncClient):
        ...
        # Cleanup
        await http.delete(
            "/mcp/sse", headers={"Mcp-Session-Id": session_id}
        )
    ...
    async def test_unknown_method_returns_error(
        ...
        resp = await mcp_call(
            http, "unknown/method", session_id=mcp_session
        )
        assert "error" in resp
        assert resp["error"]["code"] == -32601

    async def test_delete_without_header_returns_400(
...
class TestMCPMemoryTools:
    ...
    async def test_search_finds_created_memory(
        ...
        add_result = await mcp_tools_call(http, "add", {
    ...
    async def test_context(
        ...
        result = await mcp_tools_call(http, "context", {
            "memory_id": add_result["id"],
            "depth": 2,
        }, session_id=mcp_session)
    ...
    async def test_update_memory(
        ...
        update_result = await mcp_tools_call(http, "update", {
            "memory_id": memory_id,
    ...
    async def test_delete_memory(
        ...
        delete_result = await mcp_tools_call(http, "delete", {
            "memory_id": add_result["id"],
        }, session_id=mcp_session)
    ...
    async def test_stats(
        ...
        result = await mcp_tools_call(http, "stats", {
            "project_id": TEST_PROJECT_ID,
        }, session_id=mcp_session)
    ...
    async def test_stateless_tools_call(
        ...
        result = await mcp_stateless_call(http, "add", {
...
class TestMCPPinSessionTools:
    ...
    async def test_session_resume(
        ...
        result = await mcp_tools_call(http, "session_resume", {
            "project_id": TEST_PROJECT_ID,
            "expand": "smart",
            "limit": 10,
        }, session_id=mcp_session)
    ...
    async def test_pin_lifecycle(
        ...
        # Add pin
        add_result = await mcp_tools_call(http, "pin_add", {
        ...
        # Complete
        complete_result = await mcp_tools_call(http, "pin_complete", {
            "pin_id": pin_id,
        }, session_id=mcp_session)
        assert complete_result.get("status") == "completed" or "completed" in str(complete_result).lower()

        # Promote
        promote_result = await mcp_tools_call(http, "pin_promote", {
            "pin_id": pin_id,
        }, session_id=mcp_session)
    ...
    async def test_pin_add_low_importance(
        ...
        result = await mcp_tools_call(http, "pin_add", {
    ...
    async def test_session_end(
        ...
        result = await mcp_tools_call(http, "session_end", {
            "project_id": TEST_PROJECT_ID,
...
class TestMCPRelations:
    ...
    async def test_link_and_get_links(
        ...
        src, tgt = await self._create_two_memories(
            http, mcp_session, cleanup_memories
        )

        link_result = await mcp_tools_call(http, "link", {
            "source_id": src,
            "target_id": tgt,
        ...
        links_result = await mcp_tools_call(http, "get_links", {
            "memory_id": src,
            "direction": "outgoing",
        }, session_id=mcp_session)
    ...
    async def test_unlink(
        ...
        await mcp_tools_call(http, "link", {
            "source_id": src,
            "target_id": tgt,
            "relation_type": "related",
        }, session_id=mcp_session)

        unlink_result = await mcp_tools_call(http, "unlink", {
            "source_id": src,
            "target_id": tgt,
        }, session_id=mcp_session)
...
class TestMCPBatchOperations:
    ...
    async def test_batch_add_and_search(
        ...
        result = await mcp_tools_call(http, "batch_operations", {
            "operations": [
                {
                    "type": "add",
...
class TestMCPWeeklyReview:
    ...
    async def test_weekly_review(
        self, http: httpx.AsyncClient, mcp_session: str
    ):
        """weekly_review returns a report."""
        result = await mcp_tools_call(http, "weekly_review", {
            "project_id": TEST_PROJECT_ID,
            "days": 7,
        }, session_id=mcp_session)
        assert result is not None
...
class TestSSEStream:
    ...
    async def test_sse_stream_returns_endpoint_event(
        self, http: httpx.AsyncClient
    ):
    ...
    async def test_legacy_message_with_sse_response(
        self, http: httpx.AsyncClient
    ):
    ...
    async def test_sse_get_without_accept_returns_405(
        self, http: httpx.AsyncClient
    ):
        """GET /mcp/sse without Accept: text/event-stream returns 405."""
        r = await http.get(
            "/mcp/sse", headers={"Accept": "application/json"}
        )
...
class TestMCPErrorHandling:
    ...
    async def test_invalid_memory_id_for_delete(
        ...
        result = await mcp_tools_call(http, "delete", {
