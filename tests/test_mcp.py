    ...
    try:
        ...
        if response:
            ...
            if "result" in add_response:
                ...
                print(
                    f"❌ Error adding memory: {add_response.get('error', 'Unknown error')}"
                )
        ...
        search_request = {
            ...
            "params": {
                "name": "search",
                "arguments": {"query": "FastMCP 아키텍처", "limit": 5},
            },
        }
        ...
        if response:
            ...
            if "result" in search_response:
                ...
                print(
                    f"❌ Error searching: {search_response.get('error', 'Unknown error')}"
                )
        ...
        if response:
            ...
            if "result" in stats_response:
                ...
                print(
                    f"❌ Error getting stats: {stats_response.get('error', 'Unknown error')}"
                )
